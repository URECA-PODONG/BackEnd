...
public class CommunityCommentService {
	 ...
	 private final CommunityCommentRepository communityCommentRepository;
	    ...
	    public Integer create(final CommunityCommentDTO communityCommentDTO) {
	        ...
	        return communityCommentRepository.save(communityCommentEntity).getCommentId();
	    }
	    ...
	    private CommunityCommentDTO mapToDTO(final CommunityCommentEntity communityCommentEntity,
	        ...
	        communityCommentDTO.setCommentId(communityCommentEntity.getCommentId());
	        communityCommentDTO.setComment(communityCommentEntity.getComment());
	        communityCommentDTO.setUpdatedAt(communityCommentEntity.getUpdatedAt());
	        communityCommentDTO.setCreatedAt(communityCommentEntity.getCreatedAt());
	    ...
	    private CommunityCommentEntity mapToEntity(final CommunityCommentDTO communityCommentDTO,
	    	...
	    	communityCommentEntity.setUpdatedAt(communityCommentDTO.getUpdatedAt());
	    	communityCommentEntity.setCreatedAt(communityCommentDTO.getCreatedAt());
